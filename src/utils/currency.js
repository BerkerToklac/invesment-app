...
export const CURRENCY_META = {
  ...
  SAR: { symbol: 'SR', locale: 'ar-SA', name: 'Saudi Riyal', localName: 'Suudi Arabistan Riyali' },
  AED: { symbol: 'د.إ', locale: 'ar-AE', name: 'United Arab Emirates Dirham', localName: 'Birleşik Arap Emirlikleri Dirhemi' },
  QAR: { symbol: 'QR', locale: 'ar-QA', name: 'Qatari Riyal', localName: 'Katar Riyali' },
  KWD: { symbol: 'KD', locale: 'ar-KW', name: 'Kuwaiti Dinar', localName: 'Kuveyt Dinarı' },
  ILS: { symbol: '₪', locale: 'he-IL', name: 'Israeli New Shekel', localName: 'İsrail Şekeli' },
  EGP: { symbol: 'E£', locale: 'ar-EG', name: 'Egyptian Pound', localName: 'Mısır Lirası' },
